...
4. **Chatbot embed Usa la Testa**  
   ...
   **Requisiti esterni:** Origin della pagina host in whitelist APIM (match esatto hostname).  
   Su Vercel impostare `VITE_USALATESTA_PARTNER_KEY` e fare redeploy (le `VITE_*` sono incluse a build time).
